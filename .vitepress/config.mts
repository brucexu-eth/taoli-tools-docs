...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        property: "og:title",
        content: "Taoli Tools 使用手册 - 半自动化对冲套利工具",
      },
    ],
    [
      "meta",
      {
        ...
        content:
          "Taoli Tools 是一个半自动化的 U 本位对冲套利工具,支持跨所搬砖套利、永续合约资金费套利,支持数十家 CEX, DEX 和 Perp DEX",
      },
    ],
    ...
    [
      ...
      {
        property: "og:image",
        content: "https://docs.taoli.tools/og-image.png",
      },
    ],
    ...
    [
      "meta",
      {
        ...
        content: "Taoli Tools - 半自动化对冲套利工具",
      },
    ],
    // Twitter Card
    ...
    [
      "meta",
      {
        ...
        content:
          "Taoli Tools 是一个半自动化的 U 本位对冲套利工具,支持跨所搬砖套利、永续合约资金费套利",
      },
    ],
    [
      "meta",
        ...
        items: [
          ...
          { text: "基础知识", link: "/basics" },
          {
            ...
            items: [
              {
                text: "浏览器插件",
                link: "/disable-browser-cors/browser-extension",
              },
              {
                text: "命令行禁用",
                link: "/disable-browser-cors/command-line",
              },
            ],
          },
