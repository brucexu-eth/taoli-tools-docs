...
2. 点击 [交易页面](https://taoli.tools/trade) 页面右上角进入 [设置页面](https://taoli.tools/trade?settings=1)
3. 将左上角 UID 后面的数字发给 [Aliez Ren](https://telegram.me/aliez_ren)，付款后，给你开通 VIP（VIP0 无需这一步）。
...
补充：默认快速开始使用 local 模式。如果你是高阶使用者，可以查看[安装部署](./installation/)，使用远程部署模式，一步到位。
